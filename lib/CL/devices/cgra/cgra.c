...
pocl_cgra_write_configuration_file(const char* fp, const char* kname)
{
  ...
  cfg0.__lsu_cfg_0.src = (SRC_ADDR_0); cfg0.__lsu_cfg_0.src_size = (LEN-1)*sizeof(DTYPE); cfg0.__lsu_cfg_0.dst = (DST_ADDR_0); cfg0.__lsu_cfg_0.dst_size = (LEN-1)*sizeof(DTYPE);
  ...
  cfg1.__lsu_cfg_0.src = (SRC_ADDR_A); cfg1.__lsu_cfg_0.src_size = (LEN-1)*sizeof(DTYPE); cfg1.__lsu_cfg_0.dst = (DST_ADDR_C); cfg1.__lsu_cfg_0.dst_size = (LEN-1)*sizeof(DTYPE);
  cfg1.__lsu_cfg_1.src = (SRC_ADDR_B); cfg1.__lsu_cfg_1.src_size = (LEN-1)*sizeof(DTYPE); cfg1.__lsu_cfg_1.dst = (0x00000000); cfg1.__lsu_cfg_1.dst_size = 0; 
